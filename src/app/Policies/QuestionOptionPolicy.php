...
class QuestionOptionPolicy
{
    ...
    {
        return $user->can('view_any_question::option');
    }
    ...
    {
        return $user->can('view_question::option');
    }
    ...
    {
        return $user->can('create_question::option');
    }
    ...
    {
        return $user->can('update_question::option');
    }
    ...
    {
        return $user->can('delete_question::option');
    }
    ...
    {
        return $user->can('delete_any_question::option');
    }
     ...
     */
    public function replicate(User $user, QuestionOption $questionOption): bool
    {
